...
# env global
env = LinTable([(0,0), (150,1), (500,1), (5000,1), (8191,0)], size=8192)
...
melo_beat = Beat(time=noteSpeed["oneOne"], taps=8, w1=70, w2=60, w3=15, poly=1, onlyonce=False).play(delay=noteSpeed["twoOne"]*6)
